      ...
      <div className={styles.container}>
        ...
        <form>
          ...
          <div className={styles.formscolumn}>
            ...
            {/* 問題用画像のアップロード （未実装）*/}
                <div>
                  <Button variant="contained" size="small" color="inherit" >問題用画像を更新{/*<CollectionsFilled/>*/}</Button>
                </div>
            </div>
            {/* 選択肢編集 */}
            <Stack spacing={2} className="options">
            <TextField label="◯ 正解の選択肢" value={quiz.correctAnswer} onChange={changeCorrectAnswer}/>
            <TextField label="✕ 不正解の選択肢１" value={quiz.wrongAnswer1} onChange={changeWrongAnswer1}/>
            <TextField label="✕ 不正解の選択肢２" value={quiz.wrongAnswer2} onChange={changeWrongAnswer2}/>
            </Stack>
            {/* 解説編集 */}
            ...
            {/* 解説用画像のアップロード（未実装） */}
                <div>
                  <Button variant="contained" size="small" color="inherit" >解説用画像を更新{/*<CollectionsFilled/>*/}</Button>
                </div>
            </div>
          </Stack>
          </div>
