...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "explanation": "Wi-Fiは、無線通信を意味する「Wireless Fidelity」の略で、インターネット接続に使われます。",
    "questionimage": "",
    "explanationimage": "",
    "category": "ネットワーク",
    "difficulty": "普通"
  },
  {
    ...
    "options": ["オペレーティングシステム", "アプリケーションソフト", "プログラミング言語"],
    "answer": "オペレーティングシステム",
    "explanation": "Linuxはオープンソースのオペレーティングシステムで、サーバーやパソコンに広く使われています。",
    "questionimage": "",
    "explanationimage": "",
    "category": "オペレーティングシステム",
    "step": 2,
  ...
  },
  {
    ...
    "options": ["Uniform Resource Locator", "Universal Resource Locator", "Universal Remote Locator"],
    "answer": "Uniform Resource Locator",
    "explanation": "URLはウェブ上のリソースのアドレスを指し、Uniform Resource Locatorの略です。",
    "questionimage": "",
    "explanationimage": "",
    "category": "インターネット",
    "step": 50,
  ...
  },
  {
    ...
    "options": ["データの保存と管理を行うソフトウェア", "ウェブページを作成するソフトウェア", "コンピュータのパフォーマンスを最適化するツール"],
    "answer": "データの保存と管理を行うソフトウェア",
    "explanation": "DBMSは、データの保存、管理、検索、更新などを効率的に行うためのシステムです。",
    "questionimage": "",
    "explanationimage": "",
    "category": "データベース",
    "difficulty": "易しい"
  },
  {
    ...
    "options": ["HyperText Transfer Protocol", "HyperText Translation Protocol", "HyperTool Transfer Protocol"],
    "answer": "HyperText Transfer Protocol",
    "explanation": "HTTPはウェブブラウザとウェブサーバー間で情報を転送するための通信プロトコルです。",
    "questionimage": "",
    "explanationimage": "",
    "category": "ネットワーク",
    "step": 89,
  ...
  },
  {
    ...
    "answer": "0と1の組み合わせ",
    "explanation": "バイナリコードは、コンピュータがデータを扱うために使用する0と1から成るコードです。",
    "questionimage": "",
    "explanationimage": "",
    "category": "プログラミング",
    "step": 58,
  ...
  },
  {
    ...
    "options": ["ローカルでデータを保存すること", "インターネットを通じてコンピュータ資源を利用すること", "コンピュータに直接接続されたストレージデバイスを使うこと"],
    "answer": "インターネットを通じてコンピュータ資源を利用すること",
    "explanation": "クラウドコンピューティングは、インターネットを通じてデータやアプリケーションを利用する仕組みです。",
    "questionimage": "",
    "explanationimage": "",
    "category": "ネットワーク",
    "difficulty": "易しい"
  },
  {
    ...
    "options": ["Read Access Memory", "Random Access Memory", "Rapid Access Memory"],
    "answer": "Random Access Memory",
    "explanation": "RAMはコンピュータのメモリの一種で、データをランダムに読み書きできるため、この名前が付けられました。",
    "questionimage": "",
    "explanationimage": "",
    "category": "ハードウェア",
    "step": 6,
  ...
  },
  {
    ...
    "options": ["データを保存して提供する", "ユーザーが操作するための端末", "コンピュータの処理能力を高める"],
    "answer": "データを保存して提供する",
    "explanation": "サーバーは、ネットワーク上でデータやサービスを提供するコンピュータシステムです。",
    "questionimage": "",
    "explanationimage": "",
    "category": "ネットワーク",
    "step": 33,
